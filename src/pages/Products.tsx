...
const Products: React.FC = () => {
      ...
      <section className="relative h-screen flex items-center justify-center text-center">
        ...
        <div className="relative z-10 px-4">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            Our <span className="text-blue-400">Engine</span>
          </h1>
  ...
  <Link to="/products/jet-engine" aria-label={`${product.name} details`}>
    <img
      src={product.image}
      alt={product.name}
...
<div className="flex-1 text-center">
  <Link to="/products/male" aria-label="M.A.L.E. UAV details">
    <img
      src="/lovable-uploads/Male-uav.jpg"
      alt="M.A.L.E UAV"
