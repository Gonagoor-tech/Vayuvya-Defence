      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-bold">TRJ-M1</h2>
          </div>
            ...
            <CarouselContent>
              ...
              <CarouselItem>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
                  <div>
                    <h4 className="text-3xl font-bold mb-6">Product Overview</h4>
                ...
                {/* Key Specifications */}
                <div className="mb-20">
                  <h4 className="text-3xl font-bold text-center mb-12">Key Specifications</h4>
                ...
                {/* Applications */}
                <div className="mb-20">
                  <h4 className="text-3xl font-bold text-center mb-12">Applications</h4>
                ...
                <div className="bg-black/50 p-8 rounded-lg border border-gray-700">
                  <h4 className="text-3xl font-bold mb-6 text-center">Future Developments</h4>
