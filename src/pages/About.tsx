    ...
    <div className="relative font-poppins">
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-semibold text-center mb-16">Who We Are</h2>
          <div className="max-w-4xl mx-auto text-lg text-gray-300 leading-relaxed space-y-6 font-normal">
            <p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-gradient-to-br from-blue-900/20 to-gray-900/20 p-8 rounded-lg border border-gray-700">
              <h3 className="text-3xl font-semibold mb-6 text-blue-400">Our Mission</h3>
            ...
            <div className="bg-gradient-to-br from-gray-900/20 to-black/20 p-8 rounded-lg border border-gray-700">
              <h3 className="text-3xl font-semibold mb-6 text-blue-400">Our Vision</h3>
              <p className="font-normal text-lg text-gray-300 leading-relaxed">
      ...
      <section className="py-20 bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-semibold text-center mb-16">Core Values</h2>
      ...
      <section className="py-20 bg-black">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-semibold mb-8">Strategic Alignment</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-blue-900/20 to-gray-900/20 p-6 rounded-lg border border-gray-700">
              ...
              <p className="font-normal text-gray-300 text-sm">Collaborative research and development initiatives</p>
            </div>
            <div className="bg-gradient-to-br from-blue-900/20 to-gray-900/20 p-6 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-blue-400 mb-2">ISRO Collaboration</h3>
              <p className="font-normal text-gray-300 text-sm">Supporting space technology and satellite missions</p>
            </div>
            <div className="bg-gradient-to-br from-blue-900/20 to-gray-900/20 p-6 rounded-lg border border-gray-700">
              <h3 className="text-lg font-semibold text-blue-400 mb-2">GTRE Alignment</h3>
              <p className="font-normal text-gray-300 text-sm">Advanced turbine technology development</p>
            </div>
          </div>
        </div>
      </section>
