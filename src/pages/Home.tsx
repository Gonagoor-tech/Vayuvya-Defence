      ...
      <section className="relative py-12 sm:py-16 md:py-20 overflow-hidden">
        <div className="absolute inset-0 bg-black">
          <div className="absolute inset-0">
            <div className="hidden md:block absolute top-12 left-16 w-1 h-1 bg-white rounded-full animate-pulse"></div>
            <div className="hidden md:block absolute top-24 left-40 w-0.5 h-0.5 bg-blue-300 rounded-full animate-pulse delay-1000"></div>
            <div className="hidden md:block absolute top-36 left-20 w-1 h-1 bg-white rounded-full animate-pulse delay-2000"></div>
          </div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center font-poppins">
          ...
          <p className="font-[200] text-base sm:text-lg md:text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            ...
            cutting-edge solutions across aerospace, software, and AI. Our mission 
